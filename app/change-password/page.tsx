...
export default function ChangePasswordPage() {
  ...
  const handleStep1 = async () => {
    ...
    setLoading(true);
    try {
      const res = await fetch('https://myposapi.onrender.com/api/v1/auth/verify-old-password', {
        method: 'POST',
  ...
  const handleStep2 = async () => {
    ...
    try {
      ...
      const res = await fetch('https://myposapi.onrender.com/api/v1/auth/change-password-direct', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          username,
