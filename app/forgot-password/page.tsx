...
export default function ForgotPasswordPage() {
  ...
  const handleStep1 = async () => {
    ...
    setLoading(true);
    try {
      const res = await fetch('https://myposapi.onrender.com/api/v1/auth/forgot-password/send-otp', {
        method: 'POST',
  ...
  const handleStep2 = async () => {
    ...
    setLoading(true);
    try {
      const res = await fetch('https://myposapi.onrender.com/api/v1/auth/forgot-password/verify-otp', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
  ...
  const handleStep3 = async () => {
    ...
    try {
      ...
      const res = await fetch('https://myposapi.onrender.com/api/v1/auth/forgot-password', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          username: resolvedUsername.current,
